...
<div id="profilePictureModal" class="modal" style="display: none;">
    <div class="modal-content profile-pic-modal-content">
        <h3><i class="fas fa-user-circle"></i> Choose Your Profile Picture</h3>
        <p class="modal-subtitle">Select one of the available profile pictures below</p>
        <div class="profile-pic-grid">
            <div class="profile-pic-option" data-pic="avatarIconunknown.jpg">
                <img src="images/avatarIconunknown.jpg" alt="Default Avatar">
