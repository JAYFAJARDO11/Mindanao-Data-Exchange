...
check_page_access(
    ...
    null,                      // No session flag to check
    null,                      // No expected value
    'unauthorized.php',        // Redirect URL if check fails
    "You must belong to an organization to upload datasets.",
    "upload_fill"              // Error prefix to avoid conflicts
);
